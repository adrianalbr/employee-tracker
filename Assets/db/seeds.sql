...
INSERT INTO role (title, salary, department_id) values ('Manager', 75000, 8);
...
INSERT INTO role (title, salary, department_id) values ('Manager', 120000, 6);
INSERT INTO role (title, salary, department_id) values ('Officer', 80000, 6);
INSERT INTO role (title, salary, department_id) values ('Officer', 80000, 7);
